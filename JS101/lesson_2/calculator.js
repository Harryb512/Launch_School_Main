...
const MESSAGES = require('./calculator_messgaes.json');
let continueMath;
...
do {
  ...
  prompt('Would you like to make another calculation? Please enter y for yes or n for no');
  continueMath = readline.question();

  while (!['y', 'n'].includes(continueMath)) {
